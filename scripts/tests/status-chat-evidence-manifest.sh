...
require_contains "$OUTPUT" "chat_model_load_request=requires_review"
require_contains "$OUTPUT" "chat_model_selection_policy=requires_review"
require_contains "$OUTPUT" "chat_context_policy=requires_review"
require_contains "$OUTPUT" "chat_empty_state=requires_review"
require_contains "$OUTPUT" "chat_session_store_policy=requires_review"
require_contains "$OUTPUT" "chat_shortcut_map=requires_review"
require_contains "$OUTPUT" "chat_clipboard_policy=requires_review"
require_contains "$OUTPUT" "chat_attachment_policy=requires_review"
...
require_contains "$OUTPUT" "session_store_policy_gate=requires_review"
require_contains "$OUTPUT" "model_load_request_gate=requires_review"
require_contains "$OUTPUT" "model_selection_policy_gate=requires_review"
require_contains "$OUTPUT" "context_policy_gate=requires_review"
require_contains "$OUTPUT" "empty_state_gate=requires_review"
require_contains "$OUTPUT" "accessibility_review_gate=requires_review"
require_contains "$OUTPUT" "attachment_policy_gate=requires_review"
require_contains "$OUTPUT" "clipboard_policy_gate=requires_review"
require_contains "$OUTPUT" "shortcut_map_gate=requires_review"
...
require_contains "$OUTPUT" "session_store_review_pending=requires_review"
require_contains "$OUTPUT" "model_load_request_review_pending=requires_review"
require_contains "$OUTPUT" "model_selection_policy_review_pending=requires_review"
require_contains "$OUTPUT" "context_policy_review_pending=requires_review"
require_contains "$OUTPUT" "empty_state_review_pending=requires_review"
require_contains "$OUTPUT" "accessibility_review_pending=requires_review"
require_contains "$OUTPUT" "attachment_review_pending=requires_review"
require_contains "$OUTPUT" "clipboard_review_pending=requires_review"
require_contains "$OUTPUT" "shortcut_review_pending=requires_review"
...
require_contains "$OUTPUT" "review_session_store_policy=requires_review:false"
require_contains "$OUTPUT" "review_model_load_request=requires_review:false"
require_contains "$OUTPUT" "review_model_selection_policy=requires_review:false"
require_contains "$OUTPUT" "review_context_policy=requires_review:false"
require_contains "$OUTPUT" "review_empty_state=requires_review:false"
require_contains "$OUTPUT" "review_accessibility_metadata=requires_review:false"
require_contains "$OUTPUT" "review_attachment_policy=requires_review:false"
require_contains "$OUTPUT" "review_clipboard_policy=requires_review:false"
require_contains "$OUTPUT" "review_shortcut_map=requires_review:false"
...
require_contains "$OUTPUT" "sessionStorePolicyReferencedOnly=true"
require_contains "$OUTPUT" "modelLoadRequestReferencedOnly=true"
require_contains "$OUTPUT" "modelSelectionPolicyReferencedOnly=true"
require_contains "$OUTPUT" "contextPolicyReferencedOnly=true"
require_contains "$OUTPUT" "emptyStateReferencedOnly=true"
