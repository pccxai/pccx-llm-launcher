...
- Multi-OS desktop installer distribution, including download-page metadata,
  automatic update gates, BYOL Vivado/Quartus detection, local synthesis
  handoff, and cloud sync handoff. The boundary is tracked in
  [docs/DESKTOP_INSTALLER_DISTRIBUTION.md](./docs/DESKTOP_INSTALLER_DISTRIBUTION.md).
...
| [`scripts/desktop-installer-distribution-stub.sh`](./scripts/desktop-installer-distribution-stub.sh) | Data-only desktop installer distribution JSON for macOS, Windows, and Linux. Reports Tauri preference, Electron fallback, download-page metadata, signed update gates, BYOL Vivado/Quartus detection, local synthesis handoff, and cloud sync handoff as reviewed boundaries. |
